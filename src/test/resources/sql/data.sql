...
Толкин был оксфордским профессором англосаксонского языка (1925—1945), английского языка и литературы (1945—1959). Ещё в детстве Джон со своими товарищами придумали несколько языков, чтобы общаться между собой.'),
       ...
       (4, 'Брюс', 'Эккель', '1957-07-08',
        'Компьютерный программист, писатель и консультант. Его наиболее известными работами являются "Мышление на Java" и " Мышление на C++", предназначенные для программистов, желающих изучить языки программирования Java или C++, особенно для тех, у кого мало опыта в объектно-ориентированном программировании. Эккель был одним из основателей комитета по стандартам ANSI/ISO C++');
